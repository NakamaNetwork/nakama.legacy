...
namespace TreasureGuide.Entities
{
    ...
    public partial class TreasureEntities : DbContext
    {
        ...
        public virtual IQueryable<SimilarTeams_Result> SimilarTeams(Nullable<int> stageId, Nullable<int> unit1, Nullable<int> unit2, Nullable<int> unit3, Nullable<int> unit4, Nullable<int> unit5, Nullable<int> unit6)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SimilarTeams_Result>("[TreasureEntities].[SimilarTeams](@stageId, @unit1, @unit2, @unit3, @unit4, @unit5, @unit6)", stageIdParameter, unit1Parameter, unit2Parameter, unit3Parameter, unit4Parameter, unit5Parameter, unit6Parameter);
        }
