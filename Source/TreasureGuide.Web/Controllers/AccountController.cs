...
#if DEBUG
                        await _userManager.AddToRolesAsync(user, new[] { RoleConstants.Administrator, RoleConstants.Contributor, RoleConstants.BetaTester, RoleConstants.Moderator, RoleConstants.BoxUser, RoleConstants.Donor });
#endif
